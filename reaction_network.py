...
import toml
from util import expand_series_of_dicts, join_string_values
from typing import Dict, List


class ReactionNetwork():
    """
    Object with all the data that is needed to fit a statistical model of a
    metabolic reaction network, namely:
